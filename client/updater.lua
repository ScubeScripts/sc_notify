...
local resourceName = "sc_notify"

CreateThread(function()
    if GetCurrentResourceName() ~= "sc_notify" then
        resourceName = "sc_notify (" .. GetCurrentResourceName() .. ")"
    end
end)
CreateThread(function()
    while true do
        PerformHttpRequest("https://api.github.com/repos/ScubeScripts/sc_notify/releases/latest", CheckVersion, "GET")
        Wait(3600000)
    end
end)
...
function GetRepoInformations()
    ...
    PerformHttpRequest("https://api.github.com/repos/ScubeScripts/sc_notify/releases/latest", function(err, response)
        if err == 200 then
            ...
            repoURL = "https://github.com/ScubeScripts/sc_notify"
        end
    end, "GET")
    repeat
        Wait(50)
